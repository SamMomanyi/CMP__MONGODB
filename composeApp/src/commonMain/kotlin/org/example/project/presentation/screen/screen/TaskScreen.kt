...
data class TaskScreen(val task: ToDoTask? = null) : Screen {
    ...
    override fun Content() {
        ...
        Scaffold(
            // 1. TopAppBar is its own parameter
            topBar = {
                TopAppBar(
                    title = {
                        BasicTextField(
                ...
                ) // <--- TopAppBar closes here!
            },

            // 2. FloatingActionButton is a sibling of topBar (direct child of Scaffold)
            ...
            // 3. This is the Scaffold Content (The Body), which receives the padding
            BasicTextField(
                modifier = Modifier
                    .fillMaxSize()
                    .padding(all = 24.dp)
